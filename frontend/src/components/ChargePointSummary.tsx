...
const ChargePointSummary = ({ data, initialPageSize = 5 }: Props) => {
          ...
          <tbody>
            ...
            {pageData.length === 0 && (
              <tr>
                ...
                >
                  No data yet — click{" "}
                  <span className="font-medium text-blue-600">Simulate</span>.
                </td>
              </tr>
            )}
          </tbody>
        ...
        <div className="flex justify-end">
          <label className="flex items-center gap-2 text-xs text-gray-600">
            ...
            <select
              ...
              className="px-2 py-1 rounded-md border  bg-white focus:outline-none text-xs"
            >
              {PAGE_OPTIONS.map((n) => (
